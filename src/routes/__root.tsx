...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sahil Gite — Full Stack Developer & AI/ML" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Sahil Gite — Full Stack Developer & AI/ML" },
      {
        ...
        content: "MERN developer and AI/ML builder. Projects, internships and how to hire me.",
      },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <div className="flex min-h-screen flex-col font-display antialiased">
        <SiteHeader />
